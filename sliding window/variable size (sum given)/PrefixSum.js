...
// The prefix sum pattern is particularly useful for problems involving sum queries over subarrays. It allows you to compute the sum of any subarray [l, r] efficiently using the formula:sum(𝑙,𝑟)=prefixSum[𝑟]−prefixSum[𝑙−1]sum(l,r)=prefixSum[r]−prefixSum[l−1]This formula gives you the sum of elements from index l to r in constant time 𝑂(1)O(1).
// Applying Prefix Sum
...
// This approach reduces the time complexity of sum queries from O(r−l+1) to O(1).
// Example
